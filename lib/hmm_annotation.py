...
_PFAMPATH = "./hmmsearch_results/hmmsearch_pfam_sub_e15.tab"
_MDPPATH = "./hmmsearch_results/hmmsearch_mdp_sub_e15.tab"
_OVERLAPPATH = "./hmmsearch_results/hmmsearch_overlap_sub_e15.tab"
...
def main():
    ...
    pfam_ann = query_api(pfam_res, "./hmmsearch_results/pfam_evals_e15.tab")
    mdp_ann = query_api(mdp_res, "./hmmsearch_results/mdp_evals_e15.tab")
    overlap_ann = query_api(overlap_res, "./hmmsearch_results/overlap_evals_e15.tab")

    write_sig_res(pfam_ann, "./hmmsearch_results/pfam_sigs_e15.tab")
    write_sig_res(mdp_ann, "./hmmsearch_results/mdp_sigs_e15.tab")
    write_sig_res(overlap_ann, "./hmmsearch_results/overlap_sigs_e15.tab")
